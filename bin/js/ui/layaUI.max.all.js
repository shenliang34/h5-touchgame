...
(function (ui) {
    var test;
    (function (test) {
        class GameUIUI extends View {
            constructor() { super(); }
            createChildren() {
                super.createChildren();
                this.createView(ui.test.GameUIUI.uiView);
            }
        }
        GameUIUI.uiView = { "type": "View", "props": { "width": 600, "height": 400 }, "child": [{ "type": "List", "props": { "y": 3, "x": 0, "width": 600, "vScrollBarSkin": "template/List/vscroll.png", "height": 400 }, "child": [{ "type": "Box", "props": { "y": 0, "x": 0, "name": "render", "alpha": 1 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "skin": "template/List/SimpleListBoxItemBackground.png" } }, { "type": "Image", "props": { "y": 3, "x": 28, "width": 78, "skin": "template/List/message icon_57x57.png", "height": 78 } }, { "type": "Label", "props": { "y": 21, "x": 112, "width": 445, "text": "label", "skin": "template/List/label.png", "height": 50, "fontSize": 36 } }, { "type": "Image", "props": { "y": 28, "x": 600, "skin": "template/List/arrow.png" } }] }] }] };
        test.GameUIUI = GameUIUI;
